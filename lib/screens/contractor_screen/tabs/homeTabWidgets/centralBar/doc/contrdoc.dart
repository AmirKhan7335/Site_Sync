...
class ContrDocumentScreen extends StatefulWidget {
  ContrDocumentScreen({super.key, required String this.projectId});
  String projectId;
  @override
  State<ContrDocumentScreen> createState() => _DocumentScreenState();
}

class _DocumentScreenState extends State<ContrDocumentScreen> {
